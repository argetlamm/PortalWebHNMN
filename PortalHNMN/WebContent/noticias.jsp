          ...
          <div class="span4">
            <aside class="left-sidebar">
              ...
              <div class="widget">
                ...
                <ul class="cat">
                  <li><i class="icon-angle-right"></i><a href="articulos.jsp">Artículos</a><span> (2)</span></li>
            ...
            <article>
              <div class="row">
                <div class="span8">
                  ...
                  <p>
                    ¡Hay un nuevo curso disponible! Comenzaremos un nuevo curso acerca de herbología avanzada...
                  </p>
            ...
            <article>
              <div class="row">
                <div class="span8">
                  ...
                  <p>
                    ¡Hay un nuevo curso disponible! Comenzaremos un nuevo curso acerca de biología básica...
                  </p>
                  <div class="bottom-article">
                    <ul class="meta-post">
                      <li><i class="icon-calendar"></i><a href="#"> 7 de Noviembre de 2019</a></li>
