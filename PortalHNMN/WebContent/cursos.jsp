        ...
        <div class="row">
          ...
          <div class="span4">
            <div class="pricing-box-alt">
              <div class="pricing-heading">
                <h3>Introducción al <strong>muestreo</strong></h3>
              </div>
              <div class="pricing-terms">
                <h6>&#36;Valor: 10 dólares</h6>
              </div>
              <div class="pricing-content">
                <ul>
                  <li><i class="icon-ok"></i> 100 cupos disponibles</li>
                  <li><i class="icon-ok"></i> Revisión en línea</li>
          ...
          <div class="span4">
            <div class="pricing-box-alt special">
              <div class="pricing-heading">
                <h3>Curso de biología <strong>básico</strong></h3>
              </div>
              <div class="pricing-terms">
                <h6>&#36;Valor: 25 dólares</h6>
              </div>
              <div class="pricing-content">
                <ul>
                  <li><i class="icon-ok"></i> 100 cupos disponibles</li>
