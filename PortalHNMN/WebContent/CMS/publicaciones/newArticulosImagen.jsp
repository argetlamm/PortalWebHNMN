...
<link href="https://fonts.googleapis.com/css?family=Sour	ce+Sans+Pro:300,400,400i,700" rel="stylesheet">
<!-- jAlert css  -->
	  ...
	  <div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-6">
	            <h1>Nuevo [Artículo - Con imagen]</h1>
	          </div>
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              <li class="breadcrumb-item"><a href="editMenu.jsp">Publicaciones</a></li>
	              <li class="breadcrumb-item active">Nuevo artículo - Con imagen</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Nuevo artículo (Con imagen)</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div id="foto" class="panel">
              <form class="form" name="Frm-foto" method="post" action="${pageContext.request.contextPath}/SL_subirArticuloImagen" enctype="multipart/form-data"> 
               <div class="card-body">
                  		...
                  		<tr align="center">
							<td>
								<div class="cuadro-fotoNima" align="center">
									<img id="preview" src="../../img/articles/imagenEjemplo.jpg" name="preview"  alt="Foto NIMA"
