...
<title>Editar Misión | Herbario Nacional de Nicaragua</title>
...
ArrayList<Tbl_publicaciones> listaMision = new ArrayList<Tbl_publicaciones>();
listaMision = dtpb.quienesSomos();
...
for(Tbl_publicaciones tbpub : listaMision)
{
	...
	{
		if(tbpub.getGuid().trim().equals(mision))
		{
	        ...
	        <div class="row mb-2">
	          ...
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              <li class="breadcrumb-item"><a href="editMision.jsp">Misión</a></li>
	              <li class="breadcrumb-item active">Edición de la Misión</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edición de la Misión</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="${pageContext.request.contextPath}/SL_mision" method="post">
                <div class="card-body">
                <h3 class="card-title"> Recomendaciones antes de la edición de la Misión: </h3>
                <br>
                <p>
 ...
 <!-- jAlert js -->
  ...
  <script>
	...
	/////////////// ASIGNAR VALORES A LOS CONTROLES AL CARGAR LA PAGINA ///////////////
      ...
      if(nuevo == "1")
      {
        successAlert('Éxito', '"Misión" se ha editado exitosamente.');
      }
      if(nuevo == "2")
      {
