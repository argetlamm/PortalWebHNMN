...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
  ...
  <link href="../plugins/datatables-buttons/css/buttons.bootstrap4.min.css"
        rel="stylesheet">
  <!-- Theme style -->
          ...
          <div class="card">
            <div class="card-header" style="text-align:right;">
              <a href="addUserRol.jsp" class="btn btn-primary">
          	  <i class="fas fa-plus"></i>Asignar Roles a Usuarios</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                %>
	                <tr>
	                  ...
	                  <td style="text-align:center;">
	                  	<a href="#" onclick="linkEditUserRol(<%=vlistaUserRol.getId_user_rol()%>);"><i class="fas fa-edit" title="Editar"></i></a>&nbsp;&nbsp;
	                  	<a href="#" onclick="deleteUserRol(<%=vlistaUserRol.getId_user_rol()%>)"><i class="fas fa-trash" title="Eliminar"></i> </a>
...
<script>
function linkEditUserRol(userRolID)
{
...
$(document).ready(function ()
{
	...
	if(msj == "1")
	{
	  successAlert('Éxito', 'El registro ha sido agregado');
	}
});
</script>
</body>
