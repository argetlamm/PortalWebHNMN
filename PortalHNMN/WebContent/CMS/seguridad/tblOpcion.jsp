  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Control de Opciones</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="tblOpcion.jsp">Seguridad</a></li>
              <li class="breadcrumb-item active">Control de Opciones</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header" style="text-align:right;">
              <a href="newOpcion.jsp" class="btn btn-primary">
          	  <i class="fas fa-plus"></i>     Registrar Nueva Opción</a>
              </div>
            <!-- /.card-header -->
            <div class="card-body">
