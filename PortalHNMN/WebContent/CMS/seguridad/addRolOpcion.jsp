...
<title>Agregar Opción a Rol | Herbario Nacional de Nicaragua</title>
	  ...
	  <div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-6">
	            <h1>Registro [Nueva Opción a Rol]</h1>
	          </div>
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              <li class="breadcrumb-item"><a>Seguridad</a></li>
	              <li class="breadcrumb-item active">Asignar Opción a Rol</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Nueva Opción a Rol</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  <input name="opc" id="opc" type="hidden" value="1"> <!-- ESTE INPUT ES UTILIZADO PARA EL CASE DEL SERVLET -->
                  	...
                  	<div class="row">                  	
	                   ...
	                   <div class="col-md-6">
	                  		<div class="input-group mb-3">
		                   	  <label for="exampleInputEmail1">Opción:</label>
...
<!-- jAlert js -->
  ...
  <script>
    $(document).ready(function ()
    {
      ...
      if(nuevo == "1")
      {
        successAlert('Éxito', 'Las Opciones han sido asignadas!!!');
      }
      if(nuevo == "2")
      {
