            ...
            <div class="card card-primary">
              ...
              <form role="form" action="${pageContext.request.contextPath}/SL_menu" method="post">
                <div class="card-body">
                  ...
                  <input name="Item1" id="Item1" type="hidden"> <!-- ESTE INPUT ES UTILIZADO EL ID_PUBLICACIONES A EDITAR -->
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nombre del 1er Item:</label>
                    <input type="text" id="nombreMenu1" name="nombreMenu1" class="form-control" 
 ...
 <!-- jAlert js -->
  ...
  <script>
    $(document).ready(function ()
    {
    	...
    	$("#Item1").val("<%=tpub.getMenu_order()%>");
    	$("#nombreMenu1").val("<%=tpub.getPublic_titulo()%>");
