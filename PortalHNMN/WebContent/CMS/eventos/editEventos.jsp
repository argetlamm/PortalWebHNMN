...
<title>Lista de eventos | Herbario Nacional de Nicaragua</title>
              ...
              <!-- form start -->
                <div class="card-body">
                  ...
                  <%
                  		...
                  		ArrayList<Tbl_publicaciones> listaEvento = new ArrayList<Tbl_publicaciones>();
                  		listaEvento = dtpus.eventosExistentes();
                  		String titulo = "";
                  		int id = 0;
                  		
                  		for(Tbl_publicaciones tbpub : listaEvento)
                  		{
                  			titulo = tbpub.getPublic_titulo();
                  			id = tbpub.getMenu_order();
                  			%>
                  				<a href="${pageContext.request.contextPath}/SL_elegirEventoEdit?idEve=<%=id%>"><%=titulo%></a>
