	  ...
	  <div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-6">
	            <h1>Nuevo [Evento - Con imagen]</h1>
	          </div>
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              <li class="breadcrumb-item"><a href="editMenu.jsp">Eventos</a></li>
	              <li class="breadcrumb-item active">Nuevo Evento - Con imagen</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Nuevo Evento (Con imagen)</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div id="foto" class="panel">
              <form class="form" name="Frm-foto" method="post" action="${pageContext.request.contextPath}/SL_subirEventoImagen" enctype="multipart/form-data"> 
               <div class="card-body">
                  		...
                  		<tr align="center">
							<td>
								<div class="cuadro-fotoNima" align="center">
									<img id="preview" src="../../img/events/imagenEjemplo.jpg" name="preview"  alt="Foto NIMA"
