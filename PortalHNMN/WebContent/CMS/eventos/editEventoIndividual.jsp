...
<title>Editar Evento | Herbario Nacional de Nicaragua</title>
...
String idEventoCadena = request.getParameter("idEve");
int idEve = 0;
idEve = Integer.parseInt(idEventoCadena);
%>
	        ...
	        <div class="row mb-2">
	          ...
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              <li class="breadcrumb-item"><a href="editInicio.jsp">Eventos</a></li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edición de eventos</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div id="foto" class="panel">
              <form role="form" name="Frm-foto" method="post" action="${pageContext.request.contextPath}/SL_editEvento" enctype="multipart/form-data">
                <div class="card-body">
                <%
               		if(ayuda==1)
               		{
                  ...
                  <%
                  		...
                  		articuloInfo = dtpus.encontrarEvento(idEve);
    	      	...
    	      	%>
					...
					<br>
					<input type="hidden" id="categoria" name="categoria" class="form-control" value="<%=categoriaArt %>" required>
                    <label for="exampleInputEmail1">Evento Editado por: <%=nombreCompleto%></label>
                    <input type="hidden" id="redactor" name="redactor" class="form-control" value="<%=nombreCompleto%>" required>
                    <br>
                    <label for="exampleInputEmail1">Evento Escrito por: <%=redactor%></label>
                    <input type="hidden" id="idEve" name="idEve" class="form-control" value="<%=id %>" required>
...
<script src="../dist/js/demo.js"></script>
 <!-- jAlert js -->
  ...
  $(document).ready(function ()
	...
	if(nuevo == "1")
	{
		successAlert('Éxito', 'El evento ha sido editado exitosamente');
	}
	if(nuevo == "2")
	{
		errorAlert('Error', 'No se pudo editar el evento.');
	}
	if(nuevo == "3")
	{
