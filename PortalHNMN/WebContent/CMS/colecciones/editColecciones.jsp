...
<title>Editar "Colecciones" | Herbario Nacional de Nicaragua</title>
...
listaColecciones = dtpb.itemsParrafoColecciones();

String publicado = "publicado";
String colecciones = "colecciones";
String itemsProductos = "itemsProductos";
String contenido = "";
String ayudaT = "";
String ayudaC = "";
...
//Recorremos la lista
for(Tbl_publicaciones tbpub : listaColecciones)
{
	...
	{
		//Si la variable Guid del objeto a comparar es "productos", encontramos los datos de este apartado
		if(tbpub.getGuid().trim().equals(colecciones))
		{
...
<div class="wrapper">
	...
	<!-- SIDEBAR -->
	  	<jsp:include page="../../CMS/layouts/menu12.jsp"></jsp:include>
	<!-- SIDEBAR -->
	  ...
	  <div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-6">
	            <h1>Editar [Colecciones]</h1>
	          </div>
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              <li class="breadcrumb-item"><a href="editColecciones.jsp">Colecciones</a></li>
	              <li class="breadcrumb-item active">Edición de "Colecciones"</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edición de Colecciones</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="${pageContext.request.contextPath}/SL_colecciones" method="post">
                <div class="card-body">
               <%
               //Si el valor recuperado de ayuda es 1, o sea, que si desea ayuda, se imprimirá los datos recuperados
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Colecciones:</label>
                    ...
                    <!-- Este label comienza con el valor inicial del conteo hecho en la creación del formulario -->
                 	...
                 	<input type="hidden" id="colecciones" name="colecciones" class="form-control" value="colecciones" required>
                  </div>
                </div>
                <!-- /.card-body -->
 ...
 <!-- jAlert js -->
  ...
  <script>
    $(document).ready(function ()
    {
      ...
      if(nuevo == "1")
      {
        successAlert('Éxito', 'Productos se ha editado exitosamente.');
      }
      if(nuevo == "2")
      {
