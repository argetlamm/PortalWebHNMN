...
<head>
  <meta charset="utf-8">
  <title>Íconos - Herbario Nacional de Nicaragua</title>
...
<%--   	<jsp:include page="../../WEB-INF/layouts/menu.jsp"></jsp:include> --%>
    ...
    <section id="content">
      <div class="container">
        <div class="row">
          <div class="span12">
            <h4><strong>Íconos de Aplicación Web</strong></h4>
            <div class="row">
              <div class="span3">
                <ul class="the-icons">
            ...
            <!-- end divider -->
            <h4><strong>íconos de Editor de Texto</strong></h4>
            <div class="row">
              <div class="span3">
                <ul class="the-icons">
            ...
            <!-- end divider -->
            <h4><strong>Íconos Direccionales</strong></h4>
            <div class="row">
              <div class="span3">
                <ul class="the-icons">
            ...
            <!-- end divider -->
            <h4><strong>Ícono de Reprodcutor de Video</strong></h4>
            <div class="row">
              <div class="span3">
                <ul class="the-icons">
            ...
            <!-- end divider -->
            <h4><strong>íconos Médicos</strong></h4>
            <div class="row">
              <div class="span3">
                <ul class="the-icons">
            ...
            <!-- end divider -->
            <h4><strong>Íconos Sociales</strong></h4>
            <div class="row">
              <div class="span3">
                <ul class="the-icons">
