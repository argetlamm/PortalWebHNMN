...
<title>Editar "Colaboraciones" | Herbario Nacional de Nicaragua</title>
...
/* OBTENEMOS LOS DATOS DEL PARRAFO DE PRODUCTOS A SER EDITADOS */
Tbl_publicaciones tpub = new Tbl_publicaciones();
DT_publicaciones dtpb = new DT_publicaciones();
ArrayList<Tbl_publicaciones> listaColaboraciones = new ArrayList<Tbl_publicaciones>();
...
//El método itemsProductos() devuelve todos los datos del apartado Donaciones
listaColaboraciones = dtpb.itemsParrafoColab();

String publicado = "publicado";
String colaboraciones = "colaboraciones";
String contenido = "";
String ayudaT = "";
String ayudaC = "";
...
//Recorremos la lista
for(Tbl_publicaciones tbpub : listaColaboraciones)
{
	//Vemos, antes de comparar, que estén como "publicado", o sea, que tengan permitido aparecer
	if(tbpub.getPublic_estado().trim().equals(publicado))
	{
		//Si la variable Guid del objeto a comparar es "colaboraciones", encontramos los datos de este apartado
		if(tbpub.getGuid().trim().equals(colaboraciones))
		{
...
{
	//Si la variable Guid del objeto a comparar es "colaboraciones", encontramos la ayuda de este apartado
...
for(Tbl_publicaciones tbpub : listaAyudas)
{
	//Si la variable Guid del objeto a comparar es "productos", encontramos la ayuda de este apartado
	//Todas las ayudas tienen el mismo public_tipo, o sea, "ayudacms", cada una se diferencia si, por el guid
	if(tbpub.getGuid().trim().equals(colaboraciones))
	{
		//Si encontramos la solicitud, asignamos el título a una variable (que irá entre <h3>)
...
<div class="wrapper">
	...
	<!-- SIDEBAR -->
	  	<jsp:include page="../../CMS/layouts/menu13.jsp"></jsp:include>
	<!-- SIDEBAR -->
	        ...
	        <div class="row mb-2">
	          ...
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              <li class="breadcrumb-item"><a href="editColaboraciones.jsp">Colaboraciones</a></li>
	              <li class="breadcrumb-item active">Edición de "Colaboraciones"</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edición de Colaboraciones</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="${pageContext.request.contextPath}/SL_colaboraciones" method="post">
                <div class="card-body">
               <%
               //Si el valor recuperado de ayuda es 1, o sea, que si desea ayuda, se imprimirá los datos recuperados
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Colaboraciones:</label>
                    ...
                    <!-- Este label comienza con el valor inicial del conteo hecho en la creación del formulario -->
                 	...
                 	<input type="hidden" id="colaboraciones" name="colaboraciones" class="form-control" value="colaboraciones" required>
                  </div>
                </div>
                <!-- /.card-body -->
 ...
 <!-- jAlert js -->
  ...
  <script>
    $(document).ready(function ()
    {
      ...
      if(nuevo == "1")
      {
        successAlert('Éxito', 'Colaboración se ha editado exitosamente.');
      }
      if(nuevo == "2")
      {
