...
<title>Editar "Productos" | Herbario Nacional de Nicaragua</title>
...
ArrayList<Tbl_publicaciones> listaProductos = new ArrayList<Tbl_publicaciones>();
...
listaProductos = dtpb.itemsProductos();
...
//Recorremos la lista
for(Tbl_publicaciones tbpub : listaProductos)
{
	...
	if(tbpub.getPublic_estado().trim().equals(publicado))
	{
		...
		if(tbpub.getGuid().trim().equals(productos))
		{
...
<div class="wrapper">
	...
	<!-- SIDEBAR -->
	  	<jsp:include page="../../CMS/layouts/menu11.jsp"></jsp:include>
	<!-- SIDEBAR -->
	        ...
	        <div class="row mb-2">
	          ...
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              <li class="breadcrumb-item"><a href="editProductos.jsp">Productos</a></li>
	              <li class="breadcrumb-item active">Edición de "Productos"</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edición de Productos</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="${pageContext.request.contextPath}/SL_productos" method="post">
                <div class="card-body">
               <%
               //Si el valor recuperado de ayuda es 1, o sea, que si desea ayuda, se imprimirá los datos recuperados
                  ...
                  <div class="form-group">
                    ...
                    <!-- Este label comienza con el valor inicial del conteo hecho en la creación del formulario -->
                 	...
                 	<input type="hidden" id="productos" name="productos" class="form-control" value="productos" required>
                  </div>
                </div>
                <!-- /.card-body -->
