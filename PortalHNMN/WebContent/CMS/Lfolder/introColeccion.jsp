	  ...
	  <div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-6">
	            <h1>Editar [Introduccion]</h1>
	          </div>
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              <li class="breadcrumb-item"><a href="introColeccion.jsp">Parrafo Introductorio</a></li>
	              <li class="breadcrumb-item active">Edición del texto</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edición de la introduccion</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="${pageContext.request.contextPath}/SL_colecciones1" method="post">
                <div class="card-body">
 ...
 <!-- jAlert js -->
  ...
  <script>
	...
	/////////////// ASIGNAR VALORES A LOS CONTROLES AL CARGAR LA PAGINA ///////////////
      ...
      if(nuevo == "1")
      {
        successAlert('Éxito', '"Introduccion" se ha editado exitosamente.');
      }
      if(nuevo == "2")
      {
